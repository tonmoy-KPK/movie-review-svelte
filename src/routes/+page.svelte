...
<div class="relative isolate px-6 pt-14 lg:px-8">
  ...
  <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
    <div class="text-center">
      <h1
        class="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl"
      >
        Welcome
      </h1>
      <p class="font-extralight text-gray-500">
        Welocome to the movie review app
      </p>
      <div class="mt-10 flex items-center justify-center gap-x-6">
        <button
          on:click={goToPage}
          class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs cursor-pointer hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >Explore Movies <span aria-hidden="true">→</span></button
        >
      </div>
    </div>
  </div>
